    ...
    <section className="flex items-center justify-start flex-wrap gap-4 py-8 pt-4">
        <div className="msbox w-full sm:w-max p-8 pt-2 rounded-xl flex gap-2 flex-col  ">
            ...
            <p className="flex gap-2 items-center mb-4">
                <span className="text-sm">EQDHirLoAYIhplO...</span> 
                <span className="">
                    <svg width="12" height="13" viewBox="0 0 12 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_1432_1369)">
                    <path d="M10 5.19678H5.5C4.94772 5.19678 4.5 5.64449 4.5 6.19678V10.6968C4.5 11.2491 4.94772 11.6968 5.5 11.6968H10C10.5523 11.6968 11 11.2491 11 10.6968V6.19678C11 5.64449 10.5523 5.19678 10 5.19678Z" stroke="#E8EFFB" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M2.5 8.19678H2C1.73478 8.19678 1.48043 8.09142 1.29289 7.90388C1.10536 7.71635 1 7.46199 1 7.19678V2.69678C1 2.43156 1.10536 2.17721 1.29289 1.98967C1.48043 1.80213 1.73478 1.69678 2 1.69678H6.5C6.76522 1.69678 7.01957 1.80213 7.20711 1.98967C7.39464 2.17721 7.5 2.43156 7.5 2.69678V3.19678" stroke="#E8EFFB" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/>
                    </g>
                    <defs>
            ...
            <div className="flex gap-2 items-center">
                <svg width="17" height="27" viewBox="0 0 17 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M8.48909 10.3125L0 13.9398L8.48909 18.6518L16.9748 13.9398L8.48909 10.3125Z" fill="#010101" fill-opacity="0.6"/>
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M0 13.9398L8.48909 18.6518V0.706543L0 13.9398Z" fill="#00F0FF"/>
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M0 15.4509L8.48909 26.687V20.1629L0 15.4509Z" fill="#00F0FF"/>
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M8.48926 0.706543V18.6518L16.975 13.9398L8.48926 0.706543Z" fill="#A87BFF"/>
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M8.48926 20.1629V26.687L16.9817 15.4509L8.48926 20.1629Z" fill="#A87BFF"/>
                </svg>
                <h2 className="text-3xl font-bold mr-12">1520,056</h2>
            </div>
        </div>
        <div className="w-full sm:w-max">
            <h2 className="font-bold px-4  rounded-tl-xl bg-[#096D80] text-3xl rounded-t-lxl hidden sm:block module w-[60%]">Group Info</h2>
