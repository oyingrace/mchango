...
export default function Header() {
  ...
  return (
   <>
   <div className="site-details flex justify-between items-center px-12 pt-4">
   <Logo/>
    <nav className="flex items-center gap-4 sm:gap-[29px]">
    <Link className="text-[1rem] sm:text-[1.25rem] text-white" href="#">Sign In</Link>
    <Link className="text-[1rem] text-black bg-[#008080] px-[16px] py-[.75rem] sm:px-[28px] sm:py-[1rem] rounded-[15px]" href="/signup">Get Started</Link>
    </nav>
