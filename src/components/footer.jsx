  ...
  return (
   ...
   { <section className=" newsletter-section m-auto mb-0 w-full h-full absolute top-0 left-0 p-8 pb-0">
        <div className="wrapper text-white sm:flex flex-wrap gap-4  justify-center py-8 ">
           ...
           <p className="text-white flex items-center text-[1rem] mb-2"> <span><Image
               src="/PHONE.png"
               width="16"
               height="16"
               alt="icon"
               ...
               />
                  </span><Link href="tel:+2349098787472">+234 909 878 7472</Link></p>
           <p className="text-white flex items-center text-[1rem] mb-2"> <span><Image
               src="/MESSAGE.png"
               width="16"
               height="16"
               ...
               className="inline mr-2"
               />
                  </span><Link href="mailto:mchango_o@yahoo.com">mchango_o@yahoo.com</Link></p>
           <p className="text-white flex items-center text-[1rem] mb-2"> <span><Image
               src="/LOCATION.png"
               width="16"
               height="16"
               ...
               className="inline mr-2"
               />
                  </span><span>Lagos, Nigeria.</span></p>
           </div>           
        ...
        <div className="flex items-center gap-2 mt-4 sm:ml-[20%]"><Image
