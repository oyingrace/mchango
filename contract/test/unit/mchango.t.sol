...
contract MchangoTest is Script {
    ...
    address public member1 = makeAddr("User1");
    address public member2 = makeAddr("User2");
    address public member3 = makeAddr("User3");
    uint256 public constant PREMIUM_FEE = 0.00001 ether;
    ...
    function subscribePremium() internal createMember(member1) {
        ...
        mchango.subscribePremium{value: 0.00001 ether}();
        vm.stopPrank();
    }
